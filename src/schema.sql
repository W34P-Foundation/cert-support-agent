...
-- NC / Wake County (Raleigh) -- tax CORRECT
-- $189.99 x 7.25% (4.75 + 2.50) = $13.77
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000001', 'Marcus Webb', 'NC', 'Wake',
  'shipped', '1Z999AA10123456784', 'UPS', '2026-02-28',
...
-- NC / Mecklenburg County (Charlotte) -- tax CORRECT
-- $349.50 x 7.25% (4.75 + 2.50) = $25.34
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000002', 'Diana Okafor', 'NC', 'Mecklenburg',
  'delivered', '9400111899223397624928', 'USPS', '2026-02-18',
...
-- NC / Cumberland County (Fayetteville / Fort Bragg) -- tax CORRECT, still processing
-- $124.00 x 7.25% (4.75 + 2.50) = $8.99
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000003', 'Sgt. James Teller', 'NC', 'Cumberland',
...
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000004', 'Priya Nair', 'NC', 'Durham',
  'delivered', '772899333512', 'FedEx', '2026-02-15',
...
-- NC / Orange County (Chapel Hill) -- tax DISCREPANCY (overcharged)
-- $95.00 x 7.50% (4.75 + 2.75) = $7.13 expected -- $8.55 collected
-- 9% rate applied erroneously -- overcharged by $1.42
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000005', 'Keisha Monroe', 'NC', 'Orange',
  'shipped', '1ZA2R8896803871234', 'UPS', '2026-03-01',
...
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000006', 'Tom Briggs', 'NC', 'Wake',
  'returned', '1Z999AA10187654321', 'UPS', '2026-02-10',
  '[{"name":"CERT Folding Stretcher","qty":1,"sku":"CO-FS-STD"}]',
  0, 78.50, 0.0725, 5.69, 0, '2026-01-28'
);

-- NC / Guilford County (Greensboro) -- tax CORRECT
-- $445.00 x 7.00% (4.75 + 2.25) = $31.15
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000007', 'Alicia Thornton', 'NC', 'Guilford',
  'shipped', '9261290100830413889228', 'USPS', '2026-03-02',
...
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000008', 'Rafael Sandoval', 'CA', 'Los Angeles',
  'delivered', '7489023410948123', 'FedEx', '2026-02-19',
...
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000009', 'Mei-Ling Torres', 'CA', 'San Diego',
  'shipped', '1ZR290780394812345', 'UPS', '2026-03-03',
...
-- NC / Onslow County (Jacksonville / Camp Lejeune) -- tax CORRECT, still processing
-- $532.00 x 7.00% (4.75 + 2.25) = $37.24
INSERT OR IGNORE INTO orders VALUES (
  'CERT-000010', 'Cpl. Dana Rivers', 'NC', 'Onslow',
